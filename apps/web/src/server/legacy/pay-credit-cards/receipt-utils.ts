// @ts-nocheck
/**
 * Shared helpers for mark-paid receipt validation and Telegram file download.
 * Payment receipt extraction uses AI vision (receipt-validation.service.ts).
 */
...
export type ParsedReceipt = {
  ...
  amount?: number;
  amountRaw?: string;
  /** Short excerpt for failure-reply debugging. */
  rawExcerpt: string;
};
